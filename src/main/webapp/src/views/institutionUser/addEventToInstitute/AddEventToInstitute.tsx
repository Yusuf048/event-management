...
interface Props {
    isOpen: boolean;
    handleClose: () => void,
    addEventToInstitute: (model: InstituteEventModel) => void,
...
export function AddEventToInstitute(props: Props) {

    const [eventModel, setEventModel] = useState<InstituteEventModel>(initialState);
